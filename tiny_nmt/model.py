...
class NmtModel:
    ...
    def _projection_layer(self, hparams):
        """The projection layer wraps outputs of the decoder."""
        ...
        with tf.variable_scope("decoder") as decoder_scope:
            ...
            if self.mode != "infer":
                ...
                outputs, _, _ = seq2seq.dynamic_decode(
                    decoder, output_time_major=self.time_major,
                ...
                decoder = seq2seq.BasicDecoder(
                    cell, helper, decoder_init_state,
                    output_layer=self.output_layer)
                outputs, _, _ = seq2seq.dynamic_decode(
                    decoder, maximum_iterations=maximum_iterations,
                    output_time_major=self.time_major, swap_memory=True,
                    scope=decoder_scope)                
    ...
    def _update_op(self, hparams):
        ...
        self.grad_summary = [
            tf.summary.scalar("grad_norm", unclipped_grads_norm),
